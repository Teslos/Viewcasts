...
pkgdatadir = $(datadir)/viewcasts
pkglibdir = $(libdir)/viewcasts
pkgincludedir = $(includedir)/viewcasts
top_builddir = .
...
ACLOCAL = ${SHELL} /Users/toniivas/Documents/CODE/viewcasts-0.5/config/missing --run aclocal-1.7
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /Users/toniivas/Documents/CODE/viewcasts-0.5/config/missing --run tar
AUTOCONF = ${SHELL} /Users/toniivas/Documents/CODE/viewcasts-0.5/config/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/toniivas/Documents/CODE/viewcasts-0.5/config/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/toniivas/Documents/CODE/viewcasts-0.5/config/missing --run automake-1.7
AWK = awk
CC = gcc
CCAS = $(CC)
CCASFLAGS = $(CFLAGS)
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/toniivas/Documents/CODE/viewcasts-0.5/config/missing --run makeinfo
...
infodir = ${prefix}/info
install_sh = /Users/toniivas/Documents/CODE/viewcasts-0.5/config/install-sh
...
CONFIG_CLEAN_FILES =
bin_PROGRAMS = viewcasts$(EXEEXT)
PROGRAMS = $(bin_PROGRAMS)

am_viewcasts_OBJECTS =
viewcasts_OBJECTS = $(am_viewcasts_OBJECTS)
viewcasts_DEPENDENCIES = $(top_builddir)/init/libinit.la \
	$(top_builddir)/motif/libmotif.la \
	$(top_builddir)/graphics/libgraphics.la \
	$(top_builddir)/bxwidgets/lib/libBXm.a \
	$(top_builddir)/ioclient/libioclient.la \
	...
	$(top_builddir)/lib/utilii/libgen.la \
	$(top_builddir)/lib/widgets/libwidgets.la \
	$(top_builddir)/init/liberror.la $(FLEXLM_PATH)/lm_new.o
...
DIST_SOURCES = $(viewcasts_SOURCES)
...
DIST_COMMON = Makefile.am Makefile.in aclocal.m4 config.h.in \
	...
	config/mkinstalldirs configure configure.in depcomp install-sh \
	missing mkinstalldirs
DIST_SUBDIRS = $(SUBDIRS)
SOURCES = $(viewcasts_SOURCES)
...
viewcasts$(EXEEXT): $(viewcasts_OBJECTS) $(viewcasts_DEPENDENCIES) 
	@rm -f viewcasts$(EXEEXT)
	$(LINK) $(viewcasts_LDFLAGS) $(viewcasts_OBJECTS) $(viewcasts_LDADD) $(LIBS)
